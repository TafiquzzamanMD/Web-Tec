...
<?php
$message = '';  
 $name_err = $email_err = $uname_err = $pass_err = $cpass_err = $gender_err = $position_err ='';
 ...
 {  
    ...
    if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
      ...
      {  
           $position_err = "Position cannot be empty";  
      } 
...
<fieldset>
	...
	<fieldset>
				...
				<input type="radio" name="position" value="Fund Riser Stuff">Fund Riser Stuff<br>
				<input type="radio" name="position" value="Medical Team">Medical Staff<br>
				<input type="radio" name="position" value="Donation Staff">Donation Staff<br>
				<input type="radio" name="position" value=" Volunteer">Volunteer
