...
<?php
$firstname = $lastname = $email = $dd= $mm=$yyyy=$gender=$phonenumber= $bg="";
$firstnameE= $lastnameE = $emailE = $dobE=$genderE =$subjectE = $phonenumberE= $bgE="";

if ($_SERVER["REQUEST_METHOD"] == "POST") {

	if(empty($_POST["FirstName"])){
		$firstnameE="FirstName is requied";
	}
	else
	{
		$firstname = test_input($_POST["FirstName"]);
		if( preg_match("/^[0-9]/", $firstname))
			{$firstnameE="Must start with letter";}
		else if (!preg_match("/^[a-zA-Z-. ?!]{2,}$/",$firstname)) {
      	{$firstnameE = "At least two words and can only contain letters,period,dash";}
	}
}

    if(empty($_POST["LastName"])){
		$LastnameE="LastName is requied";
	}
	else
	{
		$lastname = test_input($_POST["LastName"]);
		if( preg_match("/^[0-9]/", $Lastname))
			{$lastnameE="Must start with letter";}
		else if (!preg_match("/^[a-zA-Z-. ?!]{2,}$/",$lastname)) {
      	{$lastnameE = "At least two words and can only contain letters,period,dash";}
	}
	...
	{
		$phonenumberE="Must be selected";		
	}
	else if (sizeof($_POST["phonenumber"])<2)
	{
		$phonenumberE="At least two must be selected";
	}
...
<legend><b>FIRSTNAME</b></legend>
<input type="text" firstname="firstname" value="<?php echo $firstname;?>" ><span class="error">* <?php echo $firstnameE;?> </span><br>
<hr style="border: 0.1px solid;">
<input type="submit" firstname="submit" value="submit" style="width: 100px">
</fieldset>

<br>
<fieldset style="width: 300px; ">
<legend><b>LASTNAME</b></legend>
<input type="text" lastname="lastname" value="<?php echo $lastname;?>" ><span class="error">* <?php echo $lastnameE;?> </span><br>
<hr style="border: 0.1px solid;">
<input type="submit" lastname="submit" value="submit" style="width: 100px">
...
<input type="text" name="phonenumber" value="<?php echo $phonenumber;?>"><span class="error">* <?php echo $phonenumber;?></span><br>
<hr style="border: 0.1px solid;">
<input type="submit"  value="submit" style="width: 100px">
	<br>	
	<span class="error" >* <?php echo $phonenumberE;?></span>			
